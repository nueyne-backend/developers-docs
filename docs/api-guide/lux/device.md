...
해당 페이지는 Lux 프로젝트의 치료기기와 관련된 API를 설명해놓은 페이지입니다.

## **소개**

Lux 기기 API는 사용 기록 저장, 기기 등록 등 치료기기와 관련된 작업을 수행합니다. API를 호출하기전에 인증 페이지를 읽어보시길 추천드립니다.
...
**요청 예시**
```http
POST /api/v1/lux/device/movement HTTPS
Authorization: Bearer your_token_here
{
  "real_user_id": 1,
  "device_id": 2,
